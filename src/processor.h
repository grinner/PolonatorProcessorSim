...
int ProcessImage_new(short unsigned int*,
		 short unsigned int*,
		 FILE*,
		 short unsigned int*,
		 short unsigned int*,
...
void ProcessImage_extract_new(short unsigned int*,
			  int,
			  int,
			  short unsigned int,
			  FILE*,
...
void ReceiveInitData_new(char *argv, 
			int portnum,
		        FILE *posfile,
		        FILE *infofile,
		        int curr_fcnum);
