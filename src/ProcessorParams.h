...
#define ARRAYS_PER_FC 7
#define AUTO_EXPOSURE 0
#define AUTO_EXPOSURE_TOP_PERCENT_VALUE 5
#define AUTO_EXPOSURE_THRESHOLD 9000
#define AUTO_EXPOSURE_STARTING_GAIN 20
#define AUTO_EXPOSURE_STEP_SIZE 15
